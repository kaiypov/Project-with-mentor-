...
async function readProducts(){
    ...
    <div class="text">
    <h2>${item.category}</h2>
    <span class="card_price">Цена: ${item.price}</span>
    <br/>
    <span class="card_sales">Скидка: ${item.sale}</span>
    </div>
    <div class="userIcon" id="userPanel">
    <img width="20px" src="https://cdn-icons-png.flaticon.com/512/2107/2107956.png"/>
    <button class="btnBuy">Выбрать</button>
    </div>
    <div class="admin-panel" id="admin">
    <img width="20px" src="https://cdn-icons-png.flaticon.com/512/1799/1799391.png" />
    <img width="20px" src="https://www.freeiconspng.com/thumbs/edit-icon-png/edit-new-icon-22.png"
    </div>
    </div>
    </div>
    </div>
